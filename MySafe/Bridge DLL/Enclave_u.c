...
static sgx_status_t SGX_CDECL Enclave_get_file_istream(void* pms)
{
	ms_get_file_istream_t* ms = SGX_CAST(ms_get_file_istream_t*, pms);
	get_file_istream(ms->ms_path, ms->ms_pointer, ms->ms_size, ms->ms_offset);

	return SGX_SUCCESS;
}

static sgx_status_t SGX_CDECL Enclave_get_file_ostream(void* pms)
{
	ms_get_file_ostream_t* ms = SGX_CAST(ms_get_file_ostream_t*, pms);
	get_file_ostream(ms->ms_path, ms->ms_pointer);
...
static const struct {
	...
	12,
	{
		...
		(void*)(uintptr_t)Enclave_get_file_istream,
		(void*)(uintptr_t)Enclave_get_file_ostream,
