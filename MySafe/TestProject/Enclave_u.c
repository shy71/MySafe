...
sgx_status_t seal_ex(sgx_enclave_id_t eid, uint8_t* data_buffer, size_t data_size, uint8_t* sealed_data, size_t buffer_size, size_t* actual_size)
{
	sgx_status_t status;
	ms_seal_ex_t ms;
	ms.ms_data_buffer = data_buffer;
